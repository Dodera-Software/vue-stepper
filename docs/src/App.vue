      ...
      <div class="max-w-5xl mx-auto px-6 py-12 md:py-20 space-y-24">
        ...
        <section id="introduction" class="space-y-6">
          <div class="space-y-2">
            ...
            <div class="flex flex-col">
              <h2 class="text-xl text-zinc-500 max-w-3xl leading-relaxed">
                {{ t('A headless, accessible, and customizable stepper component for Vue 3.') }}
              </h2>
              <h2 class="text-xl text-zinc-500 max-w-3xl leading-relaxed">
                {{ t('Manage complex forms and wizards with ease.') }}
              </h2>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
            <div class="flex gap-3 items-start">
              ...
              <div>
                ...
                <p class="text-sm text-zinc-500">{{ t('Sidebar collapses on mobile with scrolling.') }}</p>
              </div>
            </div>
            <div class="flex gap-3 items-start">
              <CheckCircle2 class="text-zinc-900 mt-1 shrink-0" :size="20" />
            ...
            <div class="flex gap-3 items-start">
              <CheckCircle2 class="text-zinc-900 mt-1 shrink-0" :size="20" />
              <div>
                <h3 class="font-semibold text-zinc-900">{{ t('Dark Mode') }}</h3>
                <p class="text-sm text-zinc-500">{{ t('Built-in dark mode support following system preferences.') }}</p>
              </div>
            </div>
          </div>
        ...
        <section id="installation" class="scroll-mt-20">
          ...
          <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <h4 class="font-semibold text-green-900 mb-2">✨ {{ t('Zero Config') }}</h4>
            <p class="text-sm text-green-800">{{ t('That\'s it! Styles are automatically included - no additional CSS imports or dependencies needed.') }}</p>
          </div>
        </section>
